...
namespace FootballClubApp.DAL.Migrations
{
    ...
    [Migration("20180427092136_AddGenericLeague")]
    partial class AddGenericLeague
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FootballClubApp.BLL.Entities.League", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("League");
                });
            ...
            modelBuilder.Entity("FootballClubApp.BLL.Entities.CountryLeague", b =>
                {
                    b.HasBaseType("FootballClubApp.BLL.Entities.League");
                    ...
                    b.HasDiscriminator().HasValue("CountryLeague");
                });
            ...
            modelBuilder.Entity("FootballClubApp.BLL.Entities.EuropeLeague", b =>
                {
                    ...
                    b.Property<string>("ClubName")
                        .HasColumnName("EuropeLeague_ClubName");

                    b.Property<int>("Draws")
                        .HasColumnName("EuropeLeague_Draws");

                    b.Property<int>("Loses")
                        .HasColumnName("EuropeLeague_Loses");

                    b.Property<int>("MatchesAmount")
                        .HasColumnName("EuropeLeague_MatchesAmount");

                    b.Property<string>("NameOfCompetition");

                    b.Property<int>("Place")
                        .HasColumnName("EuropeLeague_Place");

                    b.Property<int>("Points")
                        .HasColumnName("EuropeLeague_Points");

                    b.Property<int?>("SeasonsId");

                    b.Property<int>("Wins")
                        .HasColumnName("EuropeLeague_Wins");

                    b.HasIndex("SeasonsId");

                    b.ToTable("EuropeLeague");

                    b.HasDiscriminator().HasValue("EuropeLeague");
                });
            ...
            modelBuilder.Entity("FootballClubApp.BLL.Entities.EuropeLeague", b =>
                {
                    b.HasOne("FootballClubApp.BLL.Entities.Seasons")
